...
const defaultImage = defaultImageSrc; // 使用本地預設圖片

// 判斷圖片 URL，如果沒有圖片則使用預設圖片
const getImageSrc = (photo) => {
  // 檢查是否為空值、null、undefined 或空字串
...
<template>
  <main class="min-h-screen bg-slate-50 min-w-[375px] pb-20">
    ...
    <div class="relative">
      <div
        class="absolute inset-0 bg-gradient-to-br from-indigo-500/40 via-purple-500/30 to-pink-500/20 z-10"
      ></div>
      <img
      ...
      />
      <div
        class="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-slate-50 to-transparent z-20"
      ></div>
    </div>
    ...
    <div class="container mx-auto px-4">
      <!-- 篩選控制面板 -->
      <div
        class="filter-panel flex flex-col sm:flex-row items-center justify-between gap-4 my-4"
      >
        <!-- 城市篩選 -->
      ...
      <!-- 顯示篩選結果 -->
      <div
        class="stores-list grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6"
      >
        <div
        ...
        >
          <div class="md:flex">
            ...
            <div class="md:w-2/5" :style="backgroundStyle(store.spacePhoto)">
              <img
                :src="getImageSrc(store.spacePhoto)"
                alt="店家空間圖片"
            ...
            <div class="p-4 md:p-5 md:w-3/5">
              ...
              <div class="mt-3 flex flex-wrap gap-1.5">
                ...
                <span
                  class="px-2 py-0.5 bg-purple-100 text-purple-800 text-xs rounded-full"
                >
              ...
              <div class="mt-4 flex gap-3">
                ...
                <a
                  v-if="
                    store.informationURL && store.informationURL.trim() !== ''
                  "
